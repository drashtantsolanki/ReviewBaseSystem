...
public interface adminejbLocal {
    ...
    int addReview(int productId, Date date, int userId);
...
//    Collection<Object[]> getReviewxCriteriaByProductId(int productId);
    
    Collection<Reviewxcriteria> getReviewxCriteriaByProductId(int productId);
}
