...
public interface commanejbLocal {
    ...
    void removeAuthor(int AuthorId, String AuthorName);
    ...
    void removeCompany(int CompanyId, String CompanyName);
    ...
    void removeGenre(int GenreId, String GenreName);
    ...
    void removePublisher(int PublisherId, String PublisherName);
