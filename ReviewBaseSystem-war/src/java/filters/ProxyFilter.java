...
public class ProxyFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            ...
            log("ProxyFilter:DoBeforeProcessing");
...
//               res.addCookie(c);
//                    RequestDispatcher rd = req.getRequestDispatcher(req.getContextPath() + "/Admin/Roleindex.xhtml");
//                    rd.forward(request, response);
                    res.sendRedirect(req.getContextPath()+"/Admin/Roleindex.xhtml");
                } else if (sc.isCallerInRole("User")) {
                    res.sendRedirect(req.getContextPath() + "/User/userindex.xhtml");
                }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ProxyFilter:DoAfterProcessing");
        }
